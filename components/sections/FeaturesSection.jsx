...
const FEATURES = [
  ...
  { icon: Zap, title: 'Results in 30 Seconds', desc: 'Our optimized AI pipeline delivers comprehensive analysis faster than any human recruiter.', stat: '< 30s Speed', color: 'from-amber-500 to-orange-600', bg: 'rgba(245,158,11,0.08)' },
